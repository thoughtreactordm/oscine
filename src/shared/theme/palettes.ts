 ...
 *
 * Written by `scripts/make-palettes.mjs` from tailwindcss 4.3.3. Change
...
/** The 26 named ramps an operator can assign to a colour role. */
...
/**
 * Mean lightness per step across the 17 chromatic Tailwind ramps.
...
/**
 * The same, across the 9 achromatic ramps — and a genuinely
 * different ladder: `neutral-500` sits at 0.555 where the chromatic
 * mean is 0.6827.
 *
